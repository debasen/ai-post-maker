...
# Resolve repo root relative to this script (scripts/py/grok_video_downloader_v3.py)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Grok Video Downloader Utility v3")
    parser.add_argument("--project", required=True, help="Project ID (1, 2, or 3)")
